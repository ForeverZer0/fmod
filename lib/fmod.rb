...
module FMOD
  ...
  ##
  # Strings for ID3v1 tags that use a number to represent the genre. That number
  # can be used as an index into this array to retrieve the name for the genre.
  ID3V1_GENRES = %w[
    ...
    National\ Folk Swing Fusion Bebob Latin Revival Celtic Bluegrass Avantgarde
